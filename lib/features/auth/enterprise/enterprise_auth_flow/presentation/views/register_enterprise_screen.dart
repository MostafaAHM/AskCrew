...
class RegisterEnterpriseScreen extends StatefulWidget {
  ...
  @override
  State<RegisterEnterpriseScreen> createState() =>
      _RegisterEnterpriseScreenState();
}

class _RegisterEnterpriseScreenState extends State<RegisterEnterpriseScreen> {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      6.height,
                      Text(
                        AppStrings.joinUsInJustAFewSteps.tr(),
                        style: TextStyle(
                          fontSize: 17.sp,
                      ...
                      TermsCheckbox(
                        ...
                        text: AppStrings.iAcceptThe.tr(),
                        linkText: AppStrings.termsAndPrivacyPolicy.tr(),
                        onLinkTap: () {
  ...
  void _handleSignup(BuildContext context) {
    if (!_acceptTerms) {
      AppMessages.showError(context, AppStrings.youMustAcceptTermsFirst.tr());
      return;
    }
    ...
    context.go(Routes.enterpriseOnboarding, extra: basicData);
  }
}
