            ...
            child: Padding(
              ...
              child: ListView(
                children: [
                  ...
                  32.height,
                  Text(
                    AppStrings.deleteAccountWarningTitle.tr(),
                  ...
                  Column(
                    ...
                    children: [
                      _DeleteBullet(
                        text: AppStrings.deleteAccountWarningPoint1.tr(),
                      ),
                      4.height,
                      _DeleteBullet(
                        text: AppStrings.deleteAccountWarningPoint2.tr(),
                      ),
                      4.height,
                      _DeleteBullet(
                        text: AppStrings.deleteAccountWarningPoint3.tr(),
                      ),
                    ],
                  ),
                  150.height,
  ...
  void _showDeleteConfirmationDialog(
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Text(
          AppStrings.deleteAccountConfirmationMessage.tr(),
