class CreateMovieResponseModel {
  final int id;
  final String name;
  final String price;
  ...
  factory CreateMovieResponseModel.fromJson(Map<String, dynamic> json) {
    return CreateMovieResponseModel(
      id: json['id'] ?? 0,
      name: json['name'] ?? '',
      price: json['price'] ?? '',
