...
import '../cubit/user_stats_state.dart';
import 'user_stats_section.dart';

class ProfileEnterpriseBodyWidget extends StatelessWidget {
  const ProfileEnterpriseBodyWidget({super.key});
              ...
              child: ListView(
                children: [
                  ...
                  AnimatedSettingsTile(
                    ...
                    title: 'yourProfile',
                    onTap: () => context.pushNamed(Routes.yourProfile),
                  ),
                  AnimatedSettingsTile(
                    index: 1,
